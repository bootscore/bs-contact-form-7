...
jQuery(function ($) {
  ...
  document.addEventListener('wpcf7invalid', function (event) {
    ...
    $form.find('.wpcf7-response-output').addClass('alert alert-danger');
  }, false);
  
  document.addEventListener('wpcf7spam', function (event) {
    var $form = $(event.target); // Get the form that triggered the event
    $form.find('.wpcf7-response-output').removeClass('alert-danger').addClass('alert alert-warning');
  }, false);
  ...
  document.addEventListener('wpcf7mailsent', function (event) {
    var $form = $(event.target); // Get the form that triggered the event
    $form.find('.wpcf7-response-output').removeClass('alert-danger').removeClass('alert-warning').addClass('alert alert-success');
